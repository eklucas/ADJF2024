...
library(tidyverse)
library(lubridate)
library(forcats) # part of tidyverse don't really need to load separately
```

Three different datasets to illustrate various graphic options
```{r}
dispatch <- read_csv("https://raw.githubusercontent.com/eklucas/ADJF2024/refs/heads/main/graphing/dispatch.csv")
mlb <- read_csv("https://raw.githubusercontent.com/eklucas/ADJF2024/refs/heads/main/graphing/mlb.csv")
opioids <- read_csv("https://raw.githubusercontent.com/eklucas/ADJF2024/refs/heads/main/graphing/opioid-deaths.csv")
```
...
```{r}
ggplot(mlb, aes(salary)) +
  geom_histogram(bins = 20, color = 1, fill = 2) +
